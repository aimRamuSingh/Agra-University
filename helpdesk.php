...
<div class="container">
    ...
    <br>
     ...
     <?php 
        ...
        <div style="text-align:center;">
            ...
            <a href=" helpdesk.html"><button type="button" class="btn btn-primary"><h5> Back to HelpDesk </h5></button></a>        
        </div>
    ...
    <div class="text-center">
            <p style="margin: 0px" class="text-white"> Copyright © 2021 || Agra University, Agra (U.P.) || All Rights Reserved </p>
        </div>
    </footer>
    </body>
</html>