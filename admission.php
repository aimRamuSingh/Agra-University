<?php
    ...
    $q="insert into admission(DATE,NAME,FATHERNAME,MOTHERNAME,DATEOFBIRTH,GENDER,MOBILE,ADDRESS,CITY,DEGREE,STATE,NATIONALITY,COURSE,QUALIFICATION) values('$DATE','$NAME','$FATHERNAME','$MOTHERNAME','$DATEOFBIRTH','$GENDER','$MOBILE','$ADDRESS','$CITY','$DEGREE','$STATE','$NATIONALITY','$COURSE','$QUALIFICATION')";
    ...
    <br>
     ...
     <?php 
        ...
        <div style="text-align:center;">
            ...
            <a href=" Admission.html"><button type="button" class="btn btn-primary"><h5> Register More </h5></button></a>        
        </div>
